...
const SITE_KEY = import.meta.env.VITE_RECAPTCHA_SITE || ''; // ✅ Vite-compatible
      ...
      {step === 0 && (
        <>
          ...
          <div className="oauth-buttons">
            ...
            <a
              href={`${import.meta.env.VITE_AUTH}/auth/google?app=${import.meta.env.VITE_APP_NAME}`}
              className="oauth-btn google"
            >
              Login with Google
            </a>
            <a
              href={`${import.meta.env.VITE_AUTH}/auth/github?app=${import.meta.env.VITE_APP_NAME}`}
